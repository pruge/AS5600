...
#define TOTAL_ANGLE 0x01

class AS5600 : public Loop {
 public:
  AS5600(TwoWire* _wire);
  ...
  float getScaledAngle(bool totalAngle = false);
  float getNumberOfTurns();
 ...
 private:
  ...
  float startAngle = 0, totalAngle = 0;
  int quadrantNumber = 0, previousquadrantNumber = 0;  // quadrant IDs
